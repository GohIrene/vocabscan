"""
VocabScan CP2 - MobileNetV3Large training (dataset_v3, tuned + BUG FIX)
========================================================================
BUG FIX vs the previous script:
...
Run on HPC:
    python train_mobilenetv3_v3data.py --data dataset_v3
"""
...
def main():
    ...
    try:
        ...
        ax.set_title("MobileNetV3Large Confusion Matrix (test set, dataset_v3)")
