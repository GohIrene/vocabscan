"""
VocabScan CP2 - MobileNetV2 training (dataset_v4, tuned hyperparameters)
=========================================================================
Same as train_mobilenetv2_v3data.py, retargeted at dataset_v4 and with
...
Run on HPC:
    python train_mobilenetv2_v4data.py --data dataset_v4
"""
...
def main():
    ...
    try:
        ...
        ax.set_title("MobileNetV2 Confusion Matrix (test set, dataset_v4)")
