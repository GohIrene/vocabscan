...
from routes import (auth, child, children, class_code, classroom, family,
                    health, learning, logs, parent, quiz, report, revision,
                    speech, vocabulary)
...
for _bp in (health.bp, vocabulary.bp, auth.bp, children.bp, family.bp,
            child.bp, parent.bp, learning.bp, logs.bp, quiz.bp, class_code.bp,
            classroom.bp, revision.bp, report.bp, speech.bp):
